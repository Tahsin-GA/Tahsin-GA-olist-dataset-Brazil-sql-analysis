...
-- 2.98 installments in Sao Paulo to 3.74 in Salvador. 
-- 
-- This matters because Salvador is a Northeast Brazilian city with
...
-- represents a distinct regional customer profile. 
-- The business should pilot extended installment plans (e.g., 6 installments
