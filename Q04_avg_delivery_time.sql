...
-- reasons: customers are more likely to cancel or churn the
...
-- weak in isolation — it requires external benchmarking. The
-- business should treat 12.1 days as the baseline against which
